...
public class JdbcUserDao implements UserDao {
    ...
    public List<UserListItem> UserList(Long id) {
        ...
        while(results.next()){
           UserListItem userItem = mapRowToUserListItem(results);
    ...
    private UserListItem mapRowToUserListItem(SqlRowSet rowSet){

        UserListItem userListItem= new UserListItem();
        userListItem.setUserId(rowSet.getLong("user_id"));
        userListItem.setUsername(rowSet.getString("username"));
        return userListItem;
